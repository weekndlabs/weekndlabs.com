    ...
    <div className="flex flex-col gap-12 py-32 px-6 max-w-3xl mx-auto w-full">
      <SectionFadeIn>
        <h1 className="text-4xl md:text-5xl font-display text-foreground mb-4 leading-tight">
          Privacy Policy<span className="text-brand">.</span>
        </h1>
        ...
        <div className="space-y-6 text-muted-foreground leading-relaxed">
          ...
          <p>
            Because the vast majority of our products are CLI tools and self-hosted infrastructure (like Omni and ForgePod) that run directly on your machines, <strong className="text-foreground">we collect virtually zero telemetry by default</strong>. 
          </p>

          <h3 className="text-2xl font-display text-foreground pt-8 pb-2">
            What We Collect<span className="text-brand">.</span>
          </h3>
          ...
          <h3 className="text-2xl font-display text-foreground pt-8 pb-2">
            What We Never Do<span className="text-brand">.</span>
          </h3>
          <ul className="list-disc ml-6 space-y-2">
          ...
          <h3 className="text-2xl font-display text-foreground pt-8 pb-2">
            Data Protection<span className="text-brand">.</span>
          </h3>
          <p>
          ...
          <ul className="list-none pt-2">
            <li><strong className="text-foreground">Email</strong>: security@weekndlabs.com</li>
          </ul>
        </div>
      </SectionFadeIn>
    </div>
